...
func createTestGamebookWithHistory() *domain.Gamebook {
	...
	p1.AddChoice("A", 11)
	p1.AddChoice("B", 12)
	_ = gamebook.AddParagraph(p1)

	// 選択肢Bを選択してパラグラフ12に移動
	_ = p1.SelectChoice(1)
	_ = gamebook.MoveToOrCreatePlaceholder(12)

	// パラグラフ12を追加
	p12 := domain.NewParagraph(12, "test1")
	p12.AddChoice("C", 21)
	p12.AddChoice("D", 11)
	_ = gamebook.AddParagraph(p12)

	// 選択肢Dを選択してパラグラフ11に移動
	_ = p12.SelectChoice(1)
	_ = gamebook.MoveToOrCreatePlaceholder(11)
